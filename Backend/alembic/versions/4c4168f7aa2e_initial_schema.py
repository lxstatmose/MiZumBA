...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "purpose",
            sa.Enum("REFRESH", "EMAIL_CONFIRMATION", "PASSWORD_RESET", name="authtokenpurpose"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("DESIGN", "TECHNOLOGY", "PROGRAMMING", "GENERAL", name="channelcategory"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "kind", sa.Enum("AVATAR", "AUDIO", "IMAGE", "FILE", "CHANNEL_COVER", name="fileassetkind"), nullable=False
        ),
